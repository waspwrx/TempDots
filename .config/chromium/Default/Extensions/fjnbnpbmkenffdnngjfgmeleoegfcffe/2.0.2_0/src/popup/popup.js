...
function preProcessImage(style) {
    return new Promise(function (resolve, reject) {
        ...
        imageExists(style.thumbnail)
            .then(function (status) {
                if (!status) {
                    imageExists("https://userstyles.org/style_screenshots/" + styleId + "_after.jpeg").then(function (status) {
                        if (!status) {
                            imageExists("https://userstyles.org/style_screenshots/" + styleId + "_after.png").then(function (status) {
                                if (!status) {
                                    style.thumbnail = IMAGE_URL_DEFAULT;
                                } else {
                                    style.thumbnail = "https://userstyles.org/style_screenshots/" + styleId + "_after.png";
                                }
                                resolve();
                            });
                        } else {
                            style.thumbnail = "https://userstyles.org/style_screenshots/" + styleId + "_after.jpeg";
                            resolve();
                        }
                    });
                } else {
